...
namespace BET.Market.Jobs.DataAccess.EF.Defaults
{
    public class DataContext : DbContext, IDataContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RaceEntity>().Property(x => x.Name).HasColumnType("nvarchar").HasMaxLength(1024).IsOptional();
            modelBuilder.Entity<RaceEntity>().Property(x => x.SkyId).IsOptional();
            modelBuilder.Entity<RaceEntity>().Property(x => x.Time).HasColumnType("nvarchar").HasMaxLength(256).IsOptional();
            modelBuilder.Entity<RaceEntity>().Property(x => x.Weather).HasColumnType("nvarchar").HasMaxLength(256).IsOptional();
            modelBuilder.Entity<RaceEntity>().Property(x => x.Track).HasColumnType("nvarchar").HasMaxLength(256).IsOptional();
            modelBuilder.Entity<RaceEntity>().Property(x => x.Distance).HasColumnType("nvarchar").HasMaxLength(256).IsOptional();
            modelBuilder.Entity<RaceEntity>().Property(x => x.Class).HasColumnType("nvarchar").HasMaxLength(256).IsOptional();
            modelBuilder.Entity<RaceEntity>().Property(x => x.Prizemoney).HasColumnType("nvarchar").HasMaxLength(256).IsOptional();
            ...
            modelBuilder.Entity<RunnerEntity>().Property(x => x.Name).HasColumnType("nvarchar").HasMaxLength(256).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.Rating).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.LastFiveRuns).HasColumnType("nvarchar").HasMaxLength(256).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.Scratched).IsRequired();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.Barrel).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.Tcdw).HasColumnType("nvarchar").HasMaxLength(256).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.Trainer).HasColumnType("nvarchar").HasMaxLength(256).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.Jockey).HasColumnType("nvarchar").HasMaxLength(256).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.Weight).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.ResultPosition).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormSkyRating).IsRequired();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormSkyRatingPosition).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormBest12Months).IsRequired();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormBest12MonthsPosition).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormRecent).IsRequired();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormRecentPosition).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormDistance).IsRequired();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormDistancePosition).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormClass).IsRequired();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormClassPosition).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormTimeRating).IsRequired();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormTimeRatingPosition).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormInWet).IsRequired();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormInWetPosition).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormBestOverall).IsRequired();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.FormBestOverallPosition).IsOptional();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.TipSky).IsRequired();
            modelBuilder.Entity<RunnerEntity>().Property(x => x.TipSkyPosition).IsOptional();
