...
namespace BET.Market.Jobs.DataAccess.EF.Defaults
{
    public class DataServiceBET : IDataServiceBET
    {
        ...
        static DataServiceBET()
        {
        }

        public DataServiceBET() : this(new UnitOfWork())
        {    
        }

        public DataServiceBET(IUnitOfWork unitOfWork)
        {
            Id = ++objectsCounter;
        ...
        public IList<VenueEntity> GetVenues()
        {
            return UnitOfWork.VenueRepository.GetAll().ToList();
        }
